...
public class FlashLightVR : MonoBehaviour
{
    ...
    public EVRButtonId toggleButton = EVRButtonId.k_EButton_SteamVR_Touchpad;
    ...
    private void Update()
    {
        ...
        {
            if (Hand.controller.GetPressDown(toggleButton))
            {
                if (sfx)
                    PlaySoundPressed();
            ...
            if (Hand.controller.GetPressUp(toggleButton))
            {
                if (button)
